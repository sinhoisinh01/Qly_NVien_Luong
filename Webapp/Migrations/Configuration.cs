namespace Webapp.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Webapp.Models.NhanVienLuongDBContext>
    {
        ...
        protected override void Seed(Models.NhanVienLuongDBContext context)
        {
            //  This method will be called after migrating to the latest version.
            /* Add Rows for DonVi Table */
            Models.DonVi dvi = new Models.DonVi() 
            { 
                id = 1,
            ...
            Models.Ngach ngach = new Models.Ngach()
            {
                id = 1,
                ma_so = "01.001",
            ...
            // Add Rows for Ngach Table
            Models.ChucVu chucVu = new Models.ChucVu()
            {
                id = 1,
            ...
            heSoLuong = new Models.HeSoLuong()
            {
                id = 2,
                ngach = context.ngach.Find(1),
                bac_luong = 2,
            ...
            Models.TinhLuong tinhLuong = new Models.TinhLuong()
            {
                id = 1,
